...
<div align="center" style="margin-top:20px;width:600px; margin-left:350px">
	...
	<legend  style="color:black; width:300px; background:lightskyblue; padding:10px; border-radius:10px; font-size:20px; font-weight:bold;">Upload Employee Details</legend>
	
	<form  action="uploadEmployee" method="post" name="form"  >	
	   <table cellpadding="10" style="background-color: aliceblue;">
		 
				<tr>
					<td style="width: 200px; padding: 10px; font-weight:bold;">Employee Name :</td>
					<td>
					<input type="text" name="empname" id="empname" maxlength = "100" required />
					</td>
				</tr>
				<tr>
					<td style="width: 200px; padding: 10px;font-weight:bold;">Employee Location :</td>
					<td> 
					<input type="text" name="emplocation" id="emplocation" maxlength = "500" required />
					</td>
				</tr>
				<tr>
					<td style="width: 200px; padding: 10px;font-weight:bold;">Employee Email :</td>
					<td> 
					<input type="email" name="empemail" id="empemail" maxlength = "100" required/>
					</td>
				</tr>
				<tr>
					<td style="width: 200px; padding: 10px;font-weight:bold;">Employee DOB :</td>
					<td> 
					<input type="date" style="width: 187px;" name="empdob" id="empdob" required />
					</td>
				</tr>
				<tr>
